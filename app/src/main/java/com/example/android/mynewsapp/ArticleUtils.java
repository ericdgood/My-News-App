    ...
    private static List<Article> extractFeatureFromJson(String articleJSON) {
        ...
        try {
            ...
            for (int i = 0; i < resultsArray.length(); i++) {
                ...
                long time = currentArticle.getLong("webPublicationDate");
                String url = currentArticle.getString("webUrl");

                Article article = new Article(webTitle, time, url);
            ...
            Log.e("ArticleUtils", "Problem parsing the earthquake JSON results", e);
        }
